...
class S3DISDataset(Dataset):
    def __init__(self, split='train', data_root='trainval_fullarea', num_point=4096, test_area=5, block_size=1.0,
        ...
        labelweights = np.zeros(NUM_CLASSES)  ####THIS IS WHAT one needs to change to match number of objects to detect
    ...
    def __getitem__(self, idx):
        ...
        while (True):
            ...
            #print('point_idxs.size: ', point_idxs.size)
            if point_idxs.size > 1024: #1024 originally
...
class ScannetDatasetWholeScene():
    ...
    def __init__(self, root, block_points=4096, split='test', test_area=1, stride=0.5*10, block_size=1.0*10, padding=0.001):
    ...
    def __getitem__(self, index):
        ...
        for index_y in range(0, grid_y):
            #print("index_y: ", index_y, " --- grid_y: ", grid_y)
            for index_x in range(0, grid_x):
                #print("index_x: ", index_x, " --- grid_x: ", grid_x)
