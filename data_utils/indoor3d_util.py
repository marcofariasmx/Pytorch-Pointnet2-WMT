...
DATA_PATH = os.path.join(ROOT_DIR, 'data','s3dis', 'Dataset')
g_classes = [x.rstrip() for x in open(os.path.join(BASE_DIR, 'meta/class_names.txt'))]
g_class2label = {cls: i for i,cls in enumerate(g_classes)}
g_class2color = {   'clutter':	            [255, 255, 255],
                    'drive-in-rack':	    [255, 0, 0],
                    'gravity-feed-rack':    [0, 255, 0],
                    'select-rack':	        [0, 0, 255],
                    'suspended-rack':	    [255, 255, 0]}
# g_class2color = {   'clutter':	            [255, 255, 255],
#                     'rack':	                [0, 0, 255]}
